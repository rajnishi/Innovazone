...
public class LoginPO extends BasePage {
    ...
    public By UserNamme_xPath=By.xpath("//input[@name='email']");
    ...
    public boolean enterUsername(String TestEmail){
        try {
            ...
            WebElement UserNamme = (new WebDriverWait(driver,90))
                    .until(ExpectedConditions.visibilityOfElementLocated(UserNamme_xPath));
            UserNamme.sendKeys(TestEmail);
            return true;
        }
        catch (Exception e)
        {
